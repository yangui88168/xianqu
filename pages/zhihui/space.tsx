        ...
        {showPublish && (
          <div className="mt-3">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <button onClick={publish} className="ml-auto bg-green-500 text-white px-4 py-1 rounded-full text-sm">发布</button>
            </div>
          </div>
        )}
      </div>
          ...
          <div key={post.id} className="bg-white p-4 border-b">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-xs text-gray-400 ml-auto">
                {post.permission === 'private' ? '🔒' : post.permission === 'friends' ? '👥' : ''}
